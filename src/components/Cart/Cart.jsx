      ...
      <div className="grid grid-cols-1 gap-10 px-10 lg:px-32 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4">
        ...
        >
          <img
            src={food.image_url}
            alt={food.name}
            className="w-[400px] h-[200px] mx-auto  rounded-lg sm:w-[200px] sm:h-[120px] md:w-[330px] md:h-[150px] lg:w-[300px] lg:h-[200px]  hover:scale-105 cursor-pointer"
            />
...
<span className="text-sm pfont-bold py-2 pb-0 sm:text-lg md:text-xl lg:text-2xl pe-10">
          ...
          <button
            className="bg-secondary text-white w-20 mt-4 text-sm rounded-xl mb-5 py-1 hover:scale-105 sm:text-sm  lg:text-lg"
