...
export default function () {
  return (
    <div className="bg-gray-100 dark:bg-gray-800">
      ...
      <div className="container py-12  grid grid-cols-1 place-items-center ">
      <div>
          <img
            src={bike}
            className="w-full sm:max-w-lg block rounded-md mx-auto mix-blend-multiply dark:mix-blend-difference"
          />
        </div>
